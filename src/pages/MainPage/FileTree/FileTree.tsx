...
function FolderContent(props: { id?: string }) {
  ...
  return (
    <Fragment>
      {loading && <TreeItem nodeId={props.id + "__loading"} label="Loading" />}
...
export function FolderItem(props: { item: GqlListItem }) {
...
export function Folder(props: { id: string; name: string }) {
  return (
...
export function File(props: { id: string; name: string }) {
